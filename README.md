...
🧠 About Me🔬 Research Intern at IIT Bombay: Focused on non-invasive eye-tracking technology for mental health assessment and depression screening.🫀 Healthcare AI Specialist: Building high-precision diagnostic engines for PCOS screening and multimodal medical assistants.🤖 LLM & Multimodal Expert: Working with Llama-4, Whisper-large-v3, and Groq LPU for real-time speech and image reasoning.🏗️ Full-Stack ML Architect: Designing end-to-end systems from FastAPI backends to Dockerized cloud deployments.
